...
#define NTVL_HAVE_DAEMON 1
#define NTVL_HAVE_SETUID 1
/* #define NTVL_CAN_NAME_IFACE */

/* Moved here to define _CRT_SECURE_NO_WARNINGS before all the including takes place */
#ifdef WIN32
#include "win32/ntvl_win32.h"
#undef NTVL_HAVE_DAEMON
#undef NTVL_HAVE_SETUID
#endif
...
/* NTVL_IFNAMSIZ is needed on win32 even if dev_name is not used after declaration */
#define NTVL_IFNAMSIZ            16 /* 15 chars * NULL */
#ifndef WIN32
...
#define NTVL_MACSTR_SIZE 32
typedef char macstr_t[NTVL_MACSTR_SIZE];

struct peer_info {
    struct peer_info *  next;
    ntvl_community_t     community_name;
    ntvl_mac_t           mac_addr;
    ntvl_sock_t          sock;
    time_t              last_seen;
};
...
/* version.c */
extern char *ntvl_sw_version, *ntvl_sw_osName, *ntvl_sw_buildDate;
