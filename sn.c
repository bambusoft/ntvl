...
/** Send a datagram to the destination embodied in a ntvl_sock_t.
 *
...
static int process_mgmt( ntvl_sn_t * sss, 
 ...
 *
 */
static int process_udp( ntvl_sn_t * sss, 
                        const struct sockaddr_in * sender_sock,
    ...
    if ( msg_type == MSG_TYPE_PACKET ) {
        ...
        ntvl_PACKET_t                    pkt; 
        ntvl_common_t                    cmn2;
        uint8_t                         encbuf[NTVL_SN_PKTBUF_SIZE];
        size_t                          encx=0;
        ...
        if ( !from_supernode ) {
            ...
            cmn2.flags |= NTVL_FLAGS_SOCKET | NTVL_FLAGS_FROM_SUPERNODE;
        ...
        cmn2.ttl = NTVL_DEFAULT_TTL;
        cmn2.pc = ntvl_register_super_ack;
        cmn2.flags = NTVL_FLAGS_SOCKET | NTVL_FLAGS_FROM_SUPERNODE;
