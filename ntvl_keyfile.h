...
#if !defined( NTVL_KEYFILE_H_ )
#define NTVL_KEYFILE_H_


#include "ntvl_wire.h"
#include <time.h>

#define NTVL_MAX_KEYSIZE         256             /* bytes */
#define NTVL_MAX_NUM_CIPHERSPECS 8
#define NTVL_KEYPATH_SIZE        256
...
struct ntvl_cipherspec
{
    ...
    uint8_t             opaque[NTVL_MAX_KEYSIZE];/* Key matter. */
};
...
#endif /* #if !defined( NTVL_KEYFILE_H_ ) */
